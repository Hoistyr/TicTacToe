const gameBoard = (() => {
    ...
    const displayMove = (boardSquare) => {
        ...
        if (!letterSquare.classList.contains('containsMove')) {
            ...
            //Sends the click data to winLogic where it will be determined if it was a winning move
            winLogic(players, currentIndex, squareName);
        }
    ...
    const winLogic = (players, currentIndex, square) => {
        ...
        if (square === 'topLeft') {
            ...
            && logicBoard.botMid === currentWeapon){
                gameOver(players[currentIndex].name);
                gameBoard.winLines.makeWinLine();
            } else if (checkBoardFull() === true) {
                gameOver('tie');
            }
            ...
            && logicBoard.botRight === currentWeapon){
                gameOver(players[currentIndex].name);
                gameBoard.winLines.makeRightWinLine();
            } else if (logicBoard.midMid === currentWeapon 
            && logicBoard.botLeft === currentWeapon) {
                gameOver(players[currentIndex].name);
                gameBoard.winLines.makeRightAngledWinLine();
            } else if (checkBoardFull() === true) {
                gameOver('tie');
            }
            ...
            && logicBoard.midRight === currentWeapon){
                gameOver(players[currentIndex].name);
                gameBoard.winLines.makeHorizontalWinLine();
            } else if (checkBoardFull() === true) {
                gameOver('tie');
            }
            ...
            && logicBoard.botRight === currentWeapon){
                gameOver(players[currentIndex].name);
                gameBoard.winLines.makeBottomHorizontalWinLine();
            } else if (logicBoard.midMid === currentWeapon
            && logicBoard.topRight === currentWeapon) {
                gameOver(players[currentIndex].name);
                gameBoard.winLines.makeRightAngledWinLine();
